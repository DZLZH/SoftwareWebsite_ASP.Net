...
<script runat="server">
	...
	private bool CheckAuthentication()
	{
		...
		//
        return (Session["login"] != null && (bool)Session["login"] == true && Session["Mname"] != null && Session["Mname"].ToString() != "");
		//
	...
	public override void SetConfig()
	{
		...
		HtmlExtensions = new string[] {"html","htm", "txt", "js" };

        TypeConfig["File"].AllowedExtensions = new string[] { "txt", "xls", "xlsx", "doc", "docx", "gif", "jpeg", "jpg", "png", "ppt", "pptx", "rar", "zip" };
